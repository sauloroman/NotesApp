...
export const SettingsPage: React.FC = () => {
  ...
  return (
    <NotesLayout>
      <div className='h-screen grid lg:grid-cols-4 dark:bg-gray-900 dark:text-white'>
        <div className="col-span-4 lg:col-span-1 p-6 border-r border-gray-300 dark:border-gray-700">
